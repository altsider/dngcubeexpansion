...
s.fit_monster={1146427957,1172426662}
function s.ritualfil(c)
	return c:IsCode(1146427957,1172426662) and c:IsRitualMonster()
end
...
function s.filter(c)
	return c:IsCode(1108198712) and c:IsAbleToHand()
end
function s.filter2(c)
	return c:IsCode(1146427957,1172426662) and c:IsAbleToHand()
end
