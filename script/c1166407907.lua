...
function s.filter(c)
	return c:IsFaceup() and c:IsType(TYPE_LINK) and c:IsSetCard(0x1157)
end
...
function s.cfilter(c,e,tp)
	return c:IsRace(RACE_PLANT) and c:IsType(TYPE_LINK) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
