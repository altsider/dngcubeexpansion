...
function s.spfilter(c,e,tp)
	return c:IsCode(1134830502) and c:IsCanBeSpecialSummoned(e,0,tp,true,true)
end
...
function s.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc and Duel.SpecialSummon(tc,0,tp,tp,true,true,POS_FACEUP)>0 then
		tc:RegisterFlagEffect(1134830502,RESET_EVENT|RESETS_STANDARD&~(RESET_LEAVE|RESET_TEMP_REMOVE),0,0)
