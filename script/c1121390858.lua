...
s.listed_names={1119327348}
function s.spfilter1(c)
	return c:IsFaceup() and c:IsCode(1119327348) and c:IsAbleToGraveAsCost()
end
...
function s.chk(c,sg)
	return c:IsCode(1119327348) and sg:IsExists(Card.IsAttribute,1,c,ATTRIBUTE_DARK)
end
...
function s.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(s.tfilter,tp,LOCATION_DECK,0,1,nil) end
