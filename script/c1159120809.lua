...
function s.initial_effect(c)
	...
	c:RegisterEffect(e2)
	--Unaffected by activated effects of Defense Position monsters
...
function s.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsRelateToEffect(e) and s.spfilter(tc,e,tp) and Duel.GetLocationCount(tp,LOCATION_MZONE)>0
	...
	--Cannot Special Summon, except "Scareclaw" monsters
