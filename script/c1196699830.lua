...
function s.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then
		...
		local gg=not Duel.IsPlayerAffectedByEffect(tp,1169832741) and Duel.GetMatchingGroup(s.cfilter,tp,LOCATION_GRAVE,0,nil) 
	...
	local g
	if Duel.IsPlayerAffectedByEffect(tp,1169832741) then
