...
GET_SUPERIOR={
	[ATTRIBUTE_LIGHT]=ATTRIBUTE_WIND,
	[ATTRIBUTE_EARTH]=ATTRIBUTE_LIGHT,
	[ATTRIBUTE_FIRE]=ATTRIBUTE_EARTH,
	[ATTRIBUTE_DARK]=ATTRIBUTE_FIRE,
	[ATTRIBUTE_WATER]=ATTRIBUTE_DARK,
	[ATTRIBUTE_WIND]=ATTRIBUTE_WATER,
}
GET_OPPOSITE={
	[ATTRIBUTE_LIGHT]=ATTRIBUTE_DARK,
	[ATTRIBUTE_EARTH]=ATTRIBUTE_WATER,
	[ATTRIBUTE_FIRE]=ATTRIBUTE_WIND,
	[ATTRIBUTE_DARK]=ATTRIBUTE_LIGHT,
	[ATTRIBUTE_WATER]=ATTRIBUTE_EARTH,
	[ATTRIBUTE_WIND]=ATTRIBUTE_FIRE,
}
GET_INFERIOR={
	[ATTRIBUTE_LIGHT]=ATTRIBUTE_EARTH,
	[ATTRIBUTE_EARTH]=ATTRIBUTE_FIRE,
	[ATTRIBUTE_FIRE]=ATTRIBUTE_DARK,
	[ATTRIBUTE_DARK]=ATTRIBUTE_WATER,
	[ATTRIBUTE_WATER]=ATTRIBUTE_WIND,
	[ATTRIBUTE_WIND]=ATTRIBUTE_LIGHT,
}