...
s.listed_names={1123915499,1150319138}
function s.cfilter(c)
	return c:IsFaceup() and c:IsCode(1123915499)
end
function s.spfilter(c,e,tp)
	return c:IsCode(1150319138) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
