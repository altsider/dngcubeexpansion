...
function s.initial_effect(c)
	...
	c:RegisterEffect(e1)
	--fusion summon
	local params = {fusfilter=aux.FilterBoolFunction(Card.IsCode,1186240887),matfilter=s.matfilter,extrafil=s.fextra,extraop=Fusion.BanishMaterial,extratg=s.extratg}
