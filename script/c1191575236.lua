...
function s.tgfilter(c,ec)
	...
	return c:IsRace(RACE_ZOMBIE) and diff>0 and c:IsAbleToGrave()
end
...
function s.spconfilter(c,tp)
	return c:IsPreviousControler(tp) and c:GetPreviousRaceOnField()&RACE_ZOMBIE==RACE_ZOMBIE
end
