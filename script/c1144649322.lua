...
function s.spfilter(c,e,tp)
	return c:IsMonster() and c:IsSetCard(0x18e) and c:IsCanBeSpecialSummoned(e,0,tp,true,false)
end
...
function s.tgfilter(c)
	return c:IsSetCard(0x18e) and not c:IsCode(id) and c:IsAbleToGrave()
end
