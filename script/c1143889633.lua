...
function s.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc and tc:IsRelateToEffect(e) and Duel.Remove(tc,POS_FACEUP,REASON_EFFECT)~=0 and tc:IsLocation(LOCATION_REMOVED) then
		tc:RegisterFlagEffect(id+1,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END+RESET_SELF_TURN,0,1)
...
function s.spcon(e,tp,eg,ep,ev,re,r,rp)
	...
	return tc and tc:GetFlagEffect(id+1)~=0 and Duel.GetTurnPlayer()==tp
end
