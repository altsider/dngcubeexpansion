...
function s.spfilter(c,e,tp)
	return c:IsSetCard(0x015a) and c:IsCanBeSpecialSummoned(e,0,tp,false,false,POS_FACEUP_DEFENSE)
end
...
function s.thfilter(c)
	return c:IsSetCard(0x015a) and c:IsMonster() and c:IsAbleToHand()
end
