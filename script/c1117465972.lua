...
function s.cttg(e,tp,eg,ep,ev,re,r,rp,chk)
	local b1=Duel.IsExistingMatchingCard(aux.FaceupFilter(Card.IsCode,1109012916),tp,LOCATION_MZONE,0,1,nil) and Duel.GetFieldGroupCount(tp,0,LOCATION_ONFIELD)>0
...
function s.bwop(e,tp,eg,ep,ev,re,r,rp)
	...
	local tc=Duel.SelectMatchingCard(tp,aux.FaceupFilter(Card.IsCode,1109012916),tp,LOCATION_MZONE,0,1,1,nil):GetFirst()
