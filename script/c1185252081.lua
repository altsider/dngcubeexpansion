...
s.listed_names={1112369277}
function s.atcon(e)
	return e:GetHandler():GetOverlayCount()==0
end
function s.descon1(e,tp,eg,ep,ev,re,r,rp)
	return not e:GetHandler():GetOverlayGroup():IsExists(Card.IsCode,1,nil,1112369277)
end
function s.descon2(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetOverlayGroup():IsExists(Card.IsCode,1,nil,1112369277)
end
